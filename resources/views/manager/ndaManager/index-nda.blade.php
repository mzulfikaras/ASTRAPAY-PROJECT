                        ...
                        <tbody>
                            @foreach ($data as $d)
                                <tr>
                                        ...
                                        <td>{{$d->status}}</td>
                                        <td>
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{route('destroy.manager.nda',$d->id)}}" method="POST">
                                              <a href="{{ route('edit.manager.nda', $d->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                              @csrf
                                              @method('DELETE')
